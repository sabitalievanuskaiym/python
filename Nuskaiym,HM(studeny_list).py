...
print("--------------------------------------------------------------|")
print("1) Average total credits for all students-->",average_credits)
print("--------------------------------------------------------------|")
...
def student_taken_classes(arr1,arr2,student_name):
   student_list=[i for i in arr1 if i[1]==student_name]
   student_classes=[]
...
result = student_taken_classes(students, classes, "David Beckham")

if result:
    print("5) Classes taken by David Beckham:")
    print(" ")
    for course in result:
        print(course)
else:
    print("5) David Beckham has not taken any classes.")   
...
def max_credit(arr1,arr2):
    ...
    for key,val in d.items():
       if val==max(d.values()):
        st_taken.append([key,val])
    return st_taken
result = max_credit(students, classes)
...
def were_any_students_date(arr1, year, semester):
    students_list = [i[1] for i in arr1 if i[2] == year and i[3] == semester]
    return students_list
year = "2022"
semester = "Spring"

enrolled_students = were_any_students_date(students, year, semester)
